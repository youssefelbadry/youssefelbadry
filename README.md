...
Backend-focused Computer Science student with hands-on experience in building secure,
structured, and scalable backend systems using **Node.js** and **NestJS**.

🔹 **Core Focus:**
• Backend development with Node.js, NestJS, and Express  
• Writing clean, maintainable, and modular REST APIs  
• Using JavaScript (ES6+) and TypeScript in real projects  

🔹 **Authentication & Security:**
• Access & Refresh tokens (rotation & revocation)  
• OTP-based authentication and basic 2FA concepts  
• Secure file uploads and validation  
• CORS, Helmet, global error handling, and logging  

🔹 **Backend Features:**
• User management (validation, account states, soft & hard delete)  
• Background jobs and scheduled tasks  
• File handling with secure storage strategies  
...
🔹 **Frontend Experience:**
• Building responsive UIs using HTML, CSS, and JavaScript  
• Working with React for component-based interfaces  
• Integrating frontend applications with backend REST APIs  
• Handling authentication flows on the client side  
...
### 📦 ORM / ODM
<p>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/sequelize/sequelize-original.svg" width="45"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/mongoose/mongoose-original.svg" width="45"/>
</p>
